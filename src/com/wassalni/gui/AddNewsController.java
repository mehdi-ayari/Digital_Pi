...
public class AddNewsController implements Initializable {
  ...
  @FXML
    private void ajouter(ActionEvent event) throws SQLException {
        ...
        titreok = ControleSaisie.controleTextFieldOnlyLetters(tfTitre, "QUE DES LETTRES", erreurtitre);
            String titre = tfTitre.getText();
            String desc = tfDesc.getText();
            String image = tfImage.getText();
            ServiceNews sn = new ServiceNews();
            News n = new News(titre, desc,image );
           if(tfTitre.getText().equals("")||tfDesc.getText().equals("")||tfImage.getText().equals("")||(titreok)) 
